...
//	}
	...
	public String profile(Principal p,Model model,OAuth2AuthenticationToken oAuth2AuthenticationToken) {
        ...
        Account username = (Account) authentication.getDetails();
        
        Account ac = acdao.findByEmail(username.getEmail());
...
//  System.out.println(role.getName());
	...
	@GetMapping("/index/forgotpassword")
	public String forgotpass() {
		
		return "/security/forgotpassword.html";
